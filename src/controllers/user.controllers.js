  ...
  try {
    ...
    return res
      ...
      .json(
        new ApiResponse(
          200,
          { accessToken, refreshToken: newRefreshToken }, // ✅ fixed here
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  if (!avatar.url) {
    throw new ApiError(400, "Error while uploading in cloudinary(avatar)");
  }
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  if (!coverImageLocalPath) {
    throw new ApiError(404, "CvoerImage file is missing");
  }
